package com.app.pdfmaster.fragment;

import static com.app.pdfmaster.Constants.DEFAULT_BORDER_WIDTH;
import static com.app.pdfmaster.Constants.DEFAULT_COMPRESSION;
import static com.app.pdfmaster.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static com.app.pdfmaster.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static com.app.pdfmaster.Constants.DEFAULT_PAGE_COLOR;
import static com.app.pdfmaster.Constants.DEFAULT_PAGE_SIZE;
import static com.app.pdfmaster.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static com.app.pdfmaster.Constants.DEFAULT_QUALITY_VALUE;
import static com.app.pdfmaster.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static com.app.pdfmaster.Constants.MASTER_PWD_STRING;
import static com.app.pdfmaster.Constants.OPEN_SELECT_IMAGES;
import static com.app.pdfmaster.Constants.READ_PERMISSIONS;
import static com.app.pdfmaster.Constants.REQUEST_CODE_FOR_READ_PERMISSION;
import static com.app.pdfmaster.Constants.REQUEST_CODE_FOR_WRITE_PERMISSION;
import static com.app.pdfmaster.Constants.RESULT;
import static com.app.pdfmaster.Constants.STORAGE_LOCATION;
import static com.app.pdfmaster.Constants.WRITE_PERMISSIONS;
import static com.app.pdfmaster.Constants.appName;
import static com.app.pdfmaster.util.WatermarkUtils.getStyleNameFromFont;
import static com.app.pdfmaster.util.WatermarkUtils.getStyleValueFromName;
...
import com.app.pdfmaster.Constants;
import com.app.pdfmaster.R;
import com.app.pdfmaster.activities.ActivityCropImage;
import com.app.pdfmaster.activities.ActivityImageEditor;
import com.app.pdfmaster.activities.ActivityPreview;
import com.app.pdfmaster.activities.ActivityRearrangeImages;
import com.app.pdfmaster.activities.HomeActivity;
import com.app.pdfmaster.adapter.AdapterEnhancementOptions;
import com.app.pdfmaster.db.DatabaseHelper;
import com.app.pdfmaster.interfaces.OnItemClickListener;
import com.app.pdfmaster.interfaces.OnPDFCreatedInterface;
import com.app.pdfmaster.pdfModel.EnhancementOptionsEntity;
import com.app.pdfmaster.pdfModel.ImageToPDFOptions;
import com.app.pdfmaster.pdfModel.Watermark;
import com.app.pdfmaster.util.AdsUtility;
import com.app.pdfmaster.util.CreatePdf;
import com.app.pdfmaster.util.DefaultTextWatcher;
import com.app.pdfmaster.util.DialogUtils;
import com.app.pdfmaster.util.FileUtils;
import com.app.pdfmaster.util.ImageEnhancementOptionsUtils;
import com.app.pdfmaster.util.ImageUtils;
import com.app.pdfmaster.util.PageSizeUtils;
import com.app.pdfmaster.util.PermissionsUtils;
import com.app.pdfmaster.util.SharedPreferencesUtil;
import com.app.pdfmaster.util.StringUtils;
